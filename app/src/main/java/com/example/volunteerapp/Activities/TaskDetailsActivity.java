...
public class TaskDetailsActivity extends AppCompatActivity {
    ...
    void saveTask() {
        ...
        TaskModel task = new TaskModel(taskTitle, taskDescription, timestamp,taskHours,tasknum);
        task.setTitle(taskTitle);
        task.setContent(taskDescription);
        saveTaskToFirebase(task);
        Intent intent = new Intent(TaskDetailsActivity.this,TaskAddActivity.class);
